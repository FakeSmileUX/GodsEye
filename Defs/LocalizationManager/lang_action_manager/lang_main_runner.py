...
lang_start_main_menu = {
    "version_by_fakesmile": _("                                              {2}[{0}v {3}{2}]{0} BY:FakeSmile{1}").format(default_palette[4], default_palette[2], default_palette[0], version),
    "short_description": _("{1}[{0} Best Tool For Phishing With Extra Functionality {1}]").format(default_palette[2],default_palette[0]),
    "features_summary" : _("{1}[{0} Phishing-Keylogger-İnformationCollector-IpTracer {1}]").format(default_palette[2], default_palette[0]),
    ...
    "phishing_modules_header" : _("\n{0}PhishingModules:").format(default_palette[0]),
    ...
    "additional_modules" : _("\n{0}ExtraTools:").format(default_palette[0]),
...
lang_start_phishing_page = {
    ...
    "manual_reading_suggestion" : _('\n {0}[{1}*{0}]{1} Please Read The File Available At {0}[WebPages/{page}]').format(default_palette[0], default_palette[4], page = 'page'),
