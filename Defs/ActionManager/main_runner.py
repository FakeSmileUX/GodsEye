...
def start_main_menu():
    ...
    print(localization.lang_start_main_menu["version_by_fakesmile"])
    ...
    if option == '01':
        ...
        #customOption = input("\nOperation mode:\n n{0}godseye >>> {1}".format(default_palette[0], default_palette[2]))
        print(localization.lang_start_main_menu["operation_mode"])
        ...
        #customOption = input(
        #    "\nOperation mode:\ngodseye >>> {1}".format(default_palette[0], default_palette[2]))
        print(localization.lang_start_main_menu["operation_mode"])
